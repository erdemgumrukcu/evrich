...
async def request_charging_offer(item: AvailabiltiyRequest):
    ...
    available_chargers_dict['cu_02_01']={}
    available_chargers_dict['cu_02_01']["max p_ch"]=11
    available_chargers_dict['cu_02_01']["max p_ds"]=0
    available_chargers_dict['cu_02_01']["eff"]=1.0
    available_chargers_dict['cu_02_02']={}
    available_chargers_dict['cu_02_02']["max p_ch"]=22
    available_chargers_dict['cu_02_02']["max p_ds"]=22
    available_chargers_dict['cu_02_02']["eff"]=1.0
    available_chargers_dict['cu_02_03']={}
    available_chargers_dict['cu_02_03']["max p_ch"]=55
    available_chargers_dict['cu_02_03']["max p_ds"]=55
    available_chargers_dict['cu_02_03']["eff"]=1.0
